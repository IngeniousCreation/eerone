<?php
namespace PlayerxCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'playerx-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'playerx-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'playerx-core' ) => 'grid',
								esc_html__( 'Masonry', 'playerx-core' )    => 'masonry',
								esc_html__( 'Slider', 'playerx-core' )     => 'slider',
								esc_html__( 'Carousel', 'playerx-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							'type'        => 'attach_images',
							'param_name'  => 'images',
							'heading'     => esc_html__( 'Images', 'playerx-core' ),
							'description' => esc_html__( 'Select images from media library', 'playerx-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'image_size',
							'heading'     => esc_html__( 'Image Size', 'playerx-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Image Behavior', 'playerx-core' ),
							'value'      => array(
								esc_html__( 'None', 'playerx-core' )             => '',
								esc_html__( 'Open Lightbox', 'playerx-core' )    => 'lightbox',
								esc_html__( 'Open Custom Link', 'playerx-core' ) => 'custom-link',
								esc_html__( 'Zoom', 'playerx-core' )             => 'zoom',
								esc_html__( 'Grayscale', 'playerx-core' )        => 'grayscale'
							)
						),
						array(
							'type'        => 'textarea',
							'param_name'  => 'custom_links',
							'heading'     => esc_html__( 'Custom Links', 'playerx-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Custom Link Target', 'playerx-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'playerx-core' ),
							'value'       => array(
								esc_html__( 'One', 'playerx-core' )   => '1',
								esc_html__( 'Two', 'playerx-core' )   => '2',
								esc_html__( 'Three', 'playerx-core' ) => '3',
								esc_html__( 'Four', 'playerx-core' )  => '4',
								esc_html__( 'Five', 'playerx-core' )  => '5',
								esc_html__( 'Six', 'playerx-core' )   => '6'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'playerx-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_loop',
							'heading'     => esc_html__( 'Enable Slider Loop', 'playerx-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'playerx-core' ),
							'value'       => array_flip( playerx_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'playerx-core' )
						...
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'playerx-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Slide Animation Duration', 'playerx-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'playerx-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'playerx-core' ),
							'value'       => array_flip( playerx_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'playerx-core' )
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'playerx-core' ),
							'value'       => array_flip( playerx_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'playerx-core' )
	...
	public function render( $atts, $content = null ) {
		...
		$html = playerx_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
