<?php
class ElementorEdgtfPieChart extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Pie Chart', 'playerx-core' );
	}

	public function get_icon() {
		return 'playerx-elementor-custom-icon playerx-elementor-pie-chart';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'percent_color',
			[
				'label'     => esc_html__( 'Percentage Color', 'playerx-core' ),
		...
		$this->add_control(
			'active_color',
			[
				'label'     => esc_html__( 'Pie Chart Active Color', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::COLOR
			]
		);
		...
		$this->add_control(
			'inactive_color',
			[
				'label'     => esc_html__( 'Pie Chart Inactive Color', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::COLOR
			]
		);
		...
		$this->add_control(
			'size',
			[
				'label'     => esc_html__( 'Pie Chart Size (px)', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT
			]
		);
	...
	public function render() {
		...
		$params['percent']        = ! empty( $params['percent'] ) ? $params['percent'] : '69';
		...
		echo playerx_core_get_shortcode_module_template_part( 'templates/pie-chart', 'pie-chart', '', $params );
	}
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ElementorEdgtfPieChart() );
