<?php
namespace PlayerxCore\CPT\Shortcodes\FullScreenImageSlider;
...
class FullScreenImageSliderItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Full Screen Image Slider Item', 'playerx-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Background Image', 'playerx-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_top',
							'heading'     => esc_html__( 'Content Image Top', 'playerx-core' ),
							'description' => esc_html__( 'Select image from media library', 'playerx-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_left',
							'heading'     => esc_html__( 'Content Image Left', 'playerx-core' ),
							'description' => esc_html__( 'Select image from media library', 'playerx-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_right',
							'heading'     => esc_html__( 'Content Image Right', 'playerx-core' ),
							'description' => esc_html__( 'Select image from media library', 'playerx-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'subtitle',
							'heading'    => esc_html__( 'Subitle', 'playerx-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'subtitle_tag',
							'heading'     => esc_html__( 'Subitle Tag', 'playerx-core' ),
							'value'       => array_flip( playerx_edge_get_title_tag( true ) ),
							'save_always' => true,
						...
						array(
							...
							'heading'    => esc_html__( 'Subitle Color', 'playerx-core' ),
							'dependency' => array( 'element' => 'subtitle', 'not_empty' => true )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = playerx_core_get_shortcode_module_template_part( 'templates/full-screen-image-slider-item', 'full-screen-image-slider', '', $params );
