<?php
class ElementorEdgtfVideoButton extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Video Button', 'playerx-core' );
	}

	public function get_icon() {
		return 'playerx-elementor-custom-icon playerx-elementor-video-button';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'video_link',
			[
				'label'     => esc_html__( 'Video Link', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT
			]
		);
		...
		$this->add_control(
			'video_image',
			[
				'label'     => esc_html__( 'Video Image', 'playerx-core' ),
		...
		$this->add_control(
			'play_button_color',
			[
				'label'     => esc_html__( 'Play Button Color', 'playerx-core' ),
		...
		$this->add_control(
			'play_button_size',
			[
				'label'     => esc_html__( 'Play Button Size (px)', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT
			]
		);
		...
		$this->add_control(
			'play_button_image',
			[
				'label'     => esc_html__( 'Play Button Custom Image', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::MEDIA,
				'description' => esc_html__( 'Select image from media library. If you use this field then play button color and button size options will not work', 'playerx-core' )
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Play Button Custom Hover Image', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::MEDIA,
				'description' => esc_html__( 'Select image from media library. If you use this field then play button color and button size options will not work', 'playerx-core' )
			]
		);
	...
	public function render() {
		...
		echo playerx_core_get_shortcode_module_template_part( 'templates/video-button', 'video-button', '', $params );
	}
	...
	private function getPlayButtonStyles( $params ) {
		...
		if ( ! empty( $params['play_button_size'] ) ) {
			$styles[] = 'font-size: ' . playerx_edge_filter_px( $params['play_button_size'] ) . 'px';
		}
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ElementorEdgtfVideoButton() );