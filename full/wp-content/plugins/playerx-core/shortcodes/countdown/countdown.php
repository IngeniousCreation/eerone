<?php
namespace PlayerxCore\CPT\Shortcodes\Countdown;
...
class Countdown implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Countdown', 'playerx-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'skin',
							'heading'    => esc_html__( 'Skin', 'playerx-core' ),
							'value'      => array(
								esc_html__( 'Default', 'playerx-core' ) => '',
								esc_html__( 'Dark', 'playerx-core' )   => 'edgtf-dark-skin',
							),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'year',
							'heading'     => esc_html__( 'Year', 'playerx-core' ),
							'value'       => array(
								'2018' => '2018',
								'2019' => '2019',
								'2020' => '2020',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'month',
							'heading'     => esc_html__( 'Month', 'playerx-core' ),
							'value'       => array(
								esc_html__( 'January', 'playerx-core' )   => '1',
								esc_html__( 'February', 'playerx-core' )  => '2',
								esc_html__( 'March', 'playerx-core' )     => '3',
								esc_html__( 'April', 'playerx-core' )     => '4',
								esc_html__( 'May', 'playerx-core' )       => '5',
								esc_html__( 'June', 'playerx-core' )      => '6',
								esc_html__( 'July', 'playerx-core' )      => '7',
								esc_html__( 'August', 'playerx-core' )    => '8',
								esc_html__( 'September', 'playerx-core' ) => '9',
								esc_html__( 'October', 'playerx-core' )   => '10',
								esc_html__( 'November', 'playerx-core' )  => '11',
								esc_html__( 'December', 'playerx-core' )  => '12'
							),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'day',
							'heading'     => esc_html__( 'Day', 'playerx-core' ),
							'value'       => array(
								'1'  => '1',
								'2'  => '2',
								'3'  => '3',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hour',
							'heading'     => esc_html__( 'Hour', 'playerx-core' ),
							'value'       => array(
								'0'  => '0',
								'1'  => '1',
								'2'  => '2',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'minute',
							'heading'     => esc_html__( 'Minute', 'playerx-core' ),
							'value'       => array(
								'0'  => '0',
								'1'  => '1',
								'2'  => '2',
						...
						array(
							...
							'heading'    => esc_html__( 'Month Label', 'playerx-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'day_label',
							'heading'    => esc_html__( 'Day Label', 'playerx-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'hour_label',
							'heading'    => esc_html__( 'Hour Label', 'playerx-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'minute_label',
							'heading'    => esc_html__( 'Minute Label', 'playerx-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'second_label',
							'heading'    => esc_html__( 'Second Label', 'playerx-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Label Font Size (px)', 'playerx-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = playerx_core_get_shortcode_module_template_part( 'templates/countdown', 'countdown', '', $params );
