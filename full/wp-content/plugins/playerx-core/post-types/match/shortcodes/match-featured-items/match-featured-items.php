...
class MatchFeatured implements Lib\ShortcodeInterface {
	...
	public function __construct() {
		$this->base = 'edgtf_match_featured';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'                      => esc_html__( 'Match Featured Items', 'playerx-core' ),
					'base'                      => $this->getBase(),
					'category'                  => 'by PLAYERX',
					'icon'                      => 'icon-wpb-match-featured-featured-items extended-custom-icon',
					...
					'params'                    => array_merge(
						array(
							...
							array(
								'type'        => 'textfield',
								'admin_label' => true,
								'heading'     => esc_html__( 'Image Dimensions', 'playerx-core' ),
