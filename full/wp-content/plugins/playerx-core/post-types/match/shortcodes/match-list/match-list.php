...
class MatchList implements Lib\ShortcodeInterface {
	...
	public function __construct() {
		$this->base = 'edgtf_match_list';

		add_action( 'vc_before_init', array( $this, 'vcMap' ) );

		add_action( 'wp_ajax_nopriv_edgtf_core_match_ajax_load_more', array( $this, 'loadMoreMatches' ) );
		add_action( 'wp_ajax_edgtf_core_match_ajax_load_more', array( $this, 'loadMoreMatches' ) );
	}
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'                      => esc_html__( 'Match List', 'playerx-coree' ),
					'base'                      => $this->getBase(),
					'category'                  => 'by PLAYERX',
					'icon'                      => 'icon-wpb-match-list extended-custom-icon',
					'allowed_container_element' => 'vc_row',
					'params'                    => array_merge(
						array(
							array(
								'type'        => 'dropdown',
								'heading'     => esc_html__( 'Style', 'playerx-coree' ),
								'param_name'  => 'skin',
								'value'       => array(
									esc_html__( 'Dark', 'playerx-coree' )  => 'dark',
									esc_html__( 'Light', 'playerx-coree' ) => 'light'
								),
								'save_always' => true,
								'admin_label' => true,
								'description' => '',
								'group'       => esc_html__( 'Layout Options', 'playerx-coree' )
							),
							array(
								'type'        => 'dropdown',
								'heading'     => esc_html__( 'Title Tag', 'playerx-coree' ),
							...
							array(
								'type'        => 'dropdown',
								'heading'     => esc_html__( 'Team Name Tag', 'playerx-coree' ),
							...
							array(
								'type'        => 'dropdown',
								'heading'     => esc_html__( 'Show Categories', 'playerx-coree' ),
								'param_name'  => 'show_categories',
								'value'       => array(
									esc_html__( 'Yes', 'playerx-coree' ) => 'yes',
									esc_html__( 'No', 'playerx-coree' )  => 'no',
								),
								'save_always' => true,
								'admin_label' => true,
								'description' => esc_html__( 'Default value is Yes', 'playerx-coree' ),
								'group'       => esc_html__( 'Layout Options', 'playerx-coree' )
							),
							array(
								'type'        => 'dropdown',
								'heading'     => esc_html__( 'Show Date', 'playerx-coree' ),
							...
							array(
								'type'        => 'dropdown',
								'heading'     => esc_html__( 'Show Load More', 'playerx-coree' ),
								...
								'save_always' => true,
								'admin_label' => true,
								'description' => esc_html__( 'Default value is No', 'playerx-coree' ),
								'group'       => esc_html__( 'Layout Options', 'playerx-coree' )
							),
							array(
								'type'        => 'dropdown',
								'heading'     => esc_html__( 'Show Result', 'playerx-coree' ),
