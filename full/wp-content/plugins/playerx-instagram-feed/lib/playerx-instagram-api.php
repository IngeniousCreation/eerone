...
include 'playerx-instagram-helper.php';

/**
 * Class PlayerxInstagramApi
 */
class PlayerxInstagramApi {
	...
	const INSTAGRAM_CODE = 'playerx_instagram_code';
	const INSTAGRAM_USER_ID = 'playerx_instagram_user_id';
	const INSTAGRAM_TOKEN = 'playerx_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'playerx_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'playerx_instagram_access_token_long_lived_time';
	
	const FACEBOOK_CODE = 'playerx_facebook_code';
	const FACEBOOK_TOKEN = 'playerx_facebook_access_token';
	
	const CONNECTION_TYPE = 'playerx_connection_type';
	...
	public function __construct() {
		...
		$this->helper = new PlayerxInstagramHelper();
	}
	
	/**
	 * @return PlayerxInstagramApi
	 */
	 ...
	 *
	 * @see PlayerxInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see PlayerxInstagramApi::instagramExchangeCodeForToken()
	 */
