...
if ( ! class_exists( 'WPTT_WebFont_Loader' ) ) {
	...
	class WPTT_WebFont_Loader {
		 ...
		 * @var string
		 */
		protected $news_brick_kit_stylesheet_path;
		 ...
		 * @var string
		 */
		protected $news_brick_kit_stylesheet_url;
		...
		public function get_url() {
			...
			if ( $this->news_brick_kit_file_exists() ) {

				// Attempt to update the stylesheet. Return the trendy URL on success.
				if ( $this->write_stylesheet() ) {
					return $this->get_news_brick_kit_stylesheet_url();
				}
			}

			// If the trendy file exists, return its URL, with a fallback to the remote URL.
			return file_exists( $this->get_news_brick_kit_stylesheet_path() )
				? $this->get_news_brick_kit_stylesheet_url()
				: $this->remote_url;
		}
		 ...
		 * @return string
		 */
		public function get_news_brick_kit_stylesheet_url() {
			if ( ! $this->news_brick_kit_stylesheet_url ) {
				$this->news_brick_kit_stylesheet_url = str_replace(
					$this->get_base_path(),
					$this->get_base_url(),
					$this->get_news_brick_kit_stylesheet_path()
				);
			}
			return $this->news_brick_kit_stylesheet_url;
		}
		...
		public function get_styles() {
			...
			$news_brick_kit_stylesheet_contents = $this->get_news_brick_kit_stylesheet_contents();
			if ( $news_brick_kit_stylesheet_contents ) {
				return $news_brick_kit_stylesheet_contents;
			}
			...
			$files = $this->get_news_brick_kit_files_from_css();
		 ...
		 */
		public function get_news_brick_kit_stylesheet_contents() {
			$news_brick_kit_path = $this->get_news_brick_kit_stylesheet_path();
		 ...
		 */
		public function get_news_brick_kit_files_from_css() {
		...
		protected function write_stylesheet() {
			$file_path  = $this->get_news_brick_kit_stylesheet_path();
		 ...
		 * @return string
		 */
		public function get_news_brick_kit_stylesheet_path() {
			if ( ! $this->news_brick_kit_stylesheet_path ) {
				$this->news_brick_kit_stylesheet_path = $this->get_fonts_folder() . '/' . $this->get_news_brick_kit_stylesheet_filename() . '.css';
			}
			return $this->news_brick_kit_stylesheet_path;
		}
		 ...
		 * @return string
		 */
		public function get_news_brick_kit_stylesheet_filename() {
		 ...
		 * @return bool
		 */
		public function news_brick_kit_file_exists() {
			return ( ! file_exists( $this->get_news_brick_kit_stylesheet_path() ) );
		}
		...
		public function get_base_path() {
			if ( ! $this->base_path ) {
				$this->base_path = apply_filters( 'wptt_get_news_brick_kit_fonts_base_path', $this->get_filesystem()->wp_content_dir() );
			}
		...
		public function get_base_url() {
			if ( ! $this->base_url ) {
				$this->base_url = apply_filters( 'wptt_get_news_brick_kit_fonts_base_url', content_url() );
			}
		...
		public function get_subfolder_name() {
			if ( ! $this->subfolder_name ) {
				$this->subfolder_name = apply_filters( 'wptt_get_news_brick_kit_fonts_subfolder_name', 'fonts' );
			}
