							...
							<?php if ( ! $cart_is_empty ) : ?>
	                            ...
	                            <li class="edgtf-cart-bottom">
	                                ...
	                                <div class="edgtf-btn-holder clearfix">
	                                    ...
	                                    <a itemprop="url" href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="edgtf-btn edgtf-btn-simple edgtf-checkout edgtf-btn-custom-hover-bg edgtf-btn-custom-border-hover edgtf-btn-custom-hover-color"
