...
<header id="masthead" class="site-header-row-wrapper site-header siaracorporatebusiness-site-header<?php echo esc_attr( $header_class ); ?>" role="banner" <?php echo $bg_attr; ?>>
	<div class="siaracorporatebusiness-site-branding-row">
		<div class="uf-wrapper">
			<div class="siaracorporatebusiness-site-brand-ad-wrapper<?php echo esc_attr( $wrapper_class ); ?>">
				<div class="siaracorporatebusiness-site-branding-main">
				...
				if ( $ad_banner_image ) {
					...
					?>
					<div class="siaracorporatebusiness-ad-space">
						<?php
						if ( $ad_banner_link ) {
							$ad_banner_img_html  = '';
