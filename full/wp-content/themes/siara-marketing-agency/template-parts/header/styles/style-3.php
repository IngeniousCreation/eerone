	...
	<div class="primary-bar-row-wrapper">
		<div class="topbar-wrapper">
			<div class="uf-wrapper">
				...
				<!-- First Top Bar - Text Only (Left Aligned) -->
				<div class="topbar-first-row">
				...
				<!-- Second Top Bar - Join Button, Contact Info, and Social Icons -->
				<div class="topbar-second-row">
					<div class="topbar-container">
						<!-- Left Section - Join Button and Contact Info -->
						<div class="topbar-left-section">
							<!-- Join With Us Button -->
							<a href="<?php echo esc_url( $header_topbar_joinwithus_link ); ?>" class="join-with-us-btn">
								<?php echo esc_html( $header_topbar_joinwithus_text ); ?>
							...
							<div class="contact-info">
								...
								<div class="contact-item">
									...
									<a href="mailto:<?php echo esc_html( $header_mail_text ); ?>">
								...
								<div class="contact-item">
									...
									<span><?php echo esc_html( $header_time_text ); ?></span>
								</div>
							</div>
						</div>
						...
						<div class="nav-right-section">
							...
							<div class="nav-search">
								...
								<div class="search-form-container" id="searchForm">
									...
									get_search_form(
										array(
											'aria_label' => __( 'Search for:', 'siara-marketing-agency' ),
										)
									);
									?>
								</div>
