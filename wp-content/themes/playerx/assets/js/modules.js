...
(function ($) {
    ...
    */
    ...
    common.edgtfInitGridMasonryListLayout = edgtfInitGridMasonryListLayout;
...
(function ($) {
	...
	function edgtfOnWindowLoad() {
		...
		edgtfElementorFullScreenImageSlider()
	}

	/**
	 * Elementor
	 */
	function edgtfElementorFullScreenImageSlider() {
		$(window).on('elementor/frontend/init', function () {
...
(function($) {
	...
	function edgtfOnWindowLoad() {
		edgtfElementorTextMarquee();
	}

	/**
	 * Elementor
	 */
	function edgtfElementorTextMarquee(){
		$(window).on('elementor/frontend/init', function () {
...
(function($) {
	 ...
	 */
	function edgtfOnWindowLoad() {
		edgtfElementorVerticalSplitSlider();
	}

	/**
	 * Elementor
	 */
	function edgtfElementorVerticalSplitSlider() {
		$(window).on('elementor/frontend/init', function () {
...
(function ($) {
    ...
    function edgtfOnWindowLoad() {
        ...
        edgtfElementorTestimonialsCarousel();
    }

    /**
     * Elementor
     */
    function edgtfElementorTestimonialsCarousel(){
        $(window).on('elementor/frontend/init', function () {
...
(function($) {
     ...
     */
    function edgtfOnWindowLoad() {
        edgtfElementorTestimonialsImagePagination();
    }
    /**
     * Elementor
     */
    function edgtfElementorTestimonialsImagePagination(){
        $(window).on('elementor/frontend/init', function () {
            elementorFrontend.hooks.addAction( 'frontend/element_ready/edgtf_testimonials.default', function() {
                edgtfTestimonialsImagePagination();
            } );
