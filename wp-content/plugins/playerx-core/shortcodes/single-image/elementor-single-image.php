<?php
class ElementorEdgtfSingleImage extends \Elementor\Widget_Base {

	public function get_name() {
		return 'edgtf_single_image'; 
	}

	public function get_title() {
		return esc_html__( 'Single Image', 'playerx-core' );
	}

	public function get_icon() {
		return 'playerx-elementor-custom-icon playerx-elementor-single-image';
	}
		...
		$this->add_control(
			...
			[
				...
				'options' => array(
					...
					'moving' => esc_html__( 'Moving on Hover', 'playerx-core')
				),
				'default' => ''
			]
		);
	...
	public function render() {
		...
		$params['image_behavior']     = ! empty( $params['image_behavior'] ) ? $params['image_behavior'] : $params['image_behavior'];
		$params['custom_link_target'] = ! empty( $params['custom_link_target'] ) ? $params['custom_link_target'] : $params['custom_link_target'];
		
		echo playerx_core_get_shortcode_module_template_part( 'templates/single-image', 'single-image', '', $params );
	}
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ElementorEdgtfSingleImage() );