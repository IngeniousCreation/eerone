<?php
namespace PlayerxCore\CPT\Shortcodes\ImageWithText;
...
class ImageWithText implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image With Text', 'playerx-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
                        ...
                        array(
                            'type'        => 'dropdown',
                            'param_name'  => 'layout',
                            'heading'     => esc_html__( 'Element Layout', 'playerx-core' ),
                            'value'       => array(
                                esc_html__( 'Default', 'playerx-core' )      => '',
                                esc_html__( 'With Buttons', 'playerx-core' ) => 'with-buttons',
                            ),
                            'save_always' => true
                        ),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Custom Link', 'playerx-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Title Top Margin (px)', 'playerx-core' ),
							'dependency' => array( 'element' => 'title', 'not_empty' => true )
						),
						array(
							'type'       => 'textarea',
                        ...
                        array(
                            ...
                            'heading'    => esc_html__( 'Button One Text', 'playerx-core' ),
                            'dependency' => Array( 'element' => 'layout', 'value' => array( 'with-buttons' ) )
                        ),
                        array(
                            'type'       => 'textfield',
                            'param_name' => 'button_one_link',
                            'heading'    => esc_html__( 'Button One Link', 'playerx-core' ),
                            'dependency' => Array( 'element' => 'layout', 'value' => array( 'with-buttons' ) )
                        ),
                        array(
                            'type'       => 'textfield',
                            'param_name' => 'button_two_text',
                            'heading'    => esc_html__( 'Button Two Text', 'playerx-core' ),
                            'dependency' => Array( 'element' => 'layout', 'value' => array( 'with-buttons' ) )
                        ),
                        array(
                            'type'       => 'textfield',
                            'param_name' => 'button_two_link',
                            'heading'    => esc_html__( 'Button Two Link', 'playerx-core' ),
                            'dependency' => Array( 'element' => 'layout', 'value' => array( 'with-buttons' ) )
                        ),
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = playerx_core_get_shortcode_module_template_part( 'templates/image-with-text', 'image-with-text', '', $params );
