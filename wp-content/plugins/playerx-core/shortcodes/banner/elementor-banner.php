<?php
class ElementorEdgtfBanner extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Banner', 'playerx-core' );
	}

	public function get_icon() {
		return 'playerx-elementor-custom-icon playerx-elementor-banner';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'overlay_color',
			[
				'label'     => esc_html__( 'Image Overlay Color', 'playerx-core' ),
		...
		$this->add_control(
			'hover_behavior',
			[
				'label'     => esc_html__( 'Hover Behavior', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'edgtf-visible-on-hover' => esc_html__( 'Visible on Hover', 'playerx-core'), 
					'edgtf-visible-on-default' => esc_html__( 'Visible on Default', 'playerx-core'), 
					'edgtf-disabled' => esc_html__( 'Disabled', 'playerx-core')
				),
				'default' => 'edgtf-visible-on-hover'
			]
		);
		...
		$this->add_control(
			'info_position',
			[
				'label'     => esc_html__( 'Info Position', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'default' => esc_html__( 'Default', 'playerx-core'), 
					'centered' => esc_html__( 'Centered', 'playerx-core')
				),
				'default' => 'default'
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Info Content Padding', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT,
				'description' => esc_html__( 'Please insert padding in format top right bottom left', 'playerx-core' )
			]
		);
		...
		$this->add_control(
			'subtitle',
			[
				'label'     => esc_html__( 'Subtitle', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT
			]
		);
		...
		$this->add_control(
			'subtitle_tag',
			[
				'label'     => esc_html__( 'Subtitle Tag', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options' => array(
		...
		$this->add_control(
			'subtitle_color',
			[
				'label'     => esc_html__( 'Subtitle Color', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'condition' => [
					'subtitle!' => ''
				]
		...
		$this->add_control(
			'title_light_words',
			[
				'label'     => esc_html__( 'Words with Light Font Weight', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT,
				'description' => esc_html__( 'Enter the positions of the words you would like to display in a &quot;light&quot; font weight. Separate the positions with commas (e.g. if you would like the first, third, and fourth word to have a light font weight, you would enter &quot;1,3,4&quot;)', 'playerx-core' ),
				'condition' => [
					'title!' => ''
				]
			]
		...
		$this->add_control(
			'link_text',
			[
				'label'     => esc_html__( 'Link Text', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT,
				'condition' => [
					'link!' => ''
				]
		...
		$this->add_control(
			'link_color',
			[
				'label'     => esc_html__( 'Link Text Color', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'condition' => [
					'link!' => ''
				]
		...
		$this->add_control(
			'link_top_margin',
			[
				'label'     => esc_html__( 'Link Text Top Margin (px)', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT,
				'condition' => [
					'link!' => ''
				]
	...
	public function render() {
		...
		echo playerx_core_get_shortcode_module_template_part( 'templates/banner', 'banner', '', $params );
	}
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['hover_behavior'] ) ? $params['hover_behavior'] : $params['hover_behavior'];
		$holderClasses[] = ! empty( $params['info_position'] ) ? 'edgtf-banner-info-' . $params['info_position'] : 'edgtf-banner-info-' . $params['info_position'];
	...
	private function getLinkStyles( $params ) {
		...
		if ( ! empty( $params['link_top_margin'] ) ) {
			$styles[] = 'margin-top: ' . playerx_edge_filter_px( $params['link_top_margin'] ) . 'px';
		}
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ElementorEdgtfBanner() );
