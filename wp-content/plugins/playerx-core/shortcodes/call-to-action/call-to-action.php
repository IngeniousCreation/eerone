<?php
namespace PlayerxCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'playerx-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'playerx-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'playerx-core' ),
							'value'      => array(
								esc_html__( '80/20', 'playerx-core' ) => '80',
								esc_html__( '75/25', 'playerx-core' ) => '75',
								esc_html__( '66/33', 'playerx-core' ) => '66',
								esc_html__( '50/50', 'playerx-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px)', 'playerx-core' ),
						...
						array(
							'type'       => 'textarea_html',
							'param_name' => 'content',
							'heading'    => esc_html__( 'Content', 'playerx-core' ),
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'playerx-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = playerx_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
