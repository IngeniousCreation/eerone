<?php
namespace PlayerxCore\CPT\Shortcodes\FullScreenSections;
...
class FullScreenSections implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Full Screen Sections', 'playerx-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						array(
							...
							'heading'     => esc_html__( 'Enable Continuous Scrolling', 'playerx-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Navigation Arrows', 'playerx-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Pagination Dots', 'playerx-core' ),
							'value'       => array_flip( playerx_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = playerx_core_get_shortcode_module_template_part( 'templates/full-screen-sections', 'full-screen-sections', '', $params );
