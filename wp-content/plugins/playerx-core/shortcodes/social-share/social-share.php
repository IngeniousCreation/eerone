<?php
namespace PlayerxCore\CPT\Shortcodes\SocialShare;
...
class SocialShare implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Social Share', 'playerx-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						array(
							...
							'value'      => array(
								esc_html__( 'List', 'playerx-core' )     => 'list',
								esc_html__( 'Dropdown', 'playerx-core' ) => 'dropdown',
								esc_html__( 'Text', 'playerx-core' )     => 'text'
							)
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'icon_type',
							'heading'    => esc_html__( 'Icons Type', 'playerx-core' ),
							'value'      => array(
								esc_html__( 'Font Awesome', 'playerx-core' ) => 'font-awesome',
								esc_html__( 'Font Elegant', 'playerx-core' ) => 'font-elegant'
							),
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'title',
							'heading'    => esc_html__( 'Social Share Title', 'playerx-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		if ( $params['enable_social_share'] ) {
			if ( $params['enabled'] ) {
				$html .= playerx_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'social-share', '', $params );
			}
		}
