...
if ( ! class_exists( 'PlayerxCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class PlayerxCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'playerx_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	PlayerxCoreDashboardRestAPI::get_instance();
}