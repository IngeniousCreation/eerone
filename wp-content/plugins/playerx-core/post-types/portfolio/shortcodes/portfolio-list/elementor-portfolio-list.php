<?php
class ElementorEdgtfPortfolioList extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Portfolio List', 'playerx-core' );
	}

	public function get_icon() {
		return 'playerx-elementor-custom-icon playerx-elementor-portfolio-list';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'type',
			[
				'label'     => esc_html__( 'Portfolio List Template', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'gallery' => esc_html__( 'Gallery', 'playerx-core'), 
		...
		$this->add_control(
			'number_of_items',
			[
				'label'     => esc_html__( 'Number of Portfolios Per Page', 'playerx-core' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Enable Fixed Image Proportions', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Load More Top Margin (px or %)', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT,
				'condition' => [
		...
		$this->add_control(
			'filter',
			[
				'label'     => esc_html__( 'Enable Category Filter', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'no' => esc_html__( 'No', 'playerx-core'), 
					'yes' => esc_html__( 'Yes', 'playerx-core')
		...
		$this->add_control(
			'filter_order_by',
			[
				'label'     => esc_html__( 'Filter Order By', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'name' => esc_html__( 'Name', 'playerx-core'), 
					'count' => esc_html__( 'Count', 'playerx-core'), 
					'id' => esc_html__( 'Id', 'playerx-core'), 
					'slug' => esc_html__( 'Slug', 'playerx-core')
				),
				'default' => 'name',
				'condition' => [
					'filter' => array( 'yes' )
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Filter Text Transform', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'' => esc_html__( 'Default', 'playerx-core'), 
					'none' => esc_html__( 'None', 'playerx-core'), 
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Filter Bottom Margin (px or %)', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT,
				'condition' => [
					'filter' => array( 'yes' )
				]
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Enable Article Animation', 'playerx-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
	...
	public function render() {
		...
		echo playerx_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder', $params['type'], $params, $additional_params );
	}
	...
	public function getHolderInnerClasses( $params ) {
		...
		$classes[] = ! empty( $params['portfolio_slider_on'] ) && $params['portfolio_slider_on'] === 'yes' ? 'edgtf-owl-slider edgtf-list-is-slider' : '';

        if ( ! empty( $params['portfolio_slider_on'] ) && $params['portfolio_slider_on'] === 'yes' ) {
            if( $params['enable_fullheight'] === 'yes' ) {
                $classes[] = 'edgtf-ps-full-height';
            }
            if( ! empty( $params['portfolio_slider_full_height_decrease'] ) && $params['portfolio_slider_full_height_decrease'] === 'yes' ) {
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ElementorEdgtfPortfolioList() );
