...
namespace PlayerxCore\CPT\Shortcodes\Portfolio;
...
class PortfolioList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio List', 'playerx-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Portfolio List Template', 'playerx-core' ),
							'value'       => array(
								esc_html__( 'Gallery', 'playerx-core' ) => 'gallery',
								esc_html__( 'Masonry', 'playerx-core' ) => 'masonry'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Click Behavior', 'playerx-core' ),
							'value'      => array(
								esc_html__( 'Open portfolio single page on click', 'playerx-core' )   => '',
								esc_html__( 'Open gallery in Pretty Photo on click', 'playerx-core' ) => 'gallery'
							)
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'number_of_columns',
							'heading'     => esc_html__( 'Number of Columns', 'playerx-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Space Between Items', 'playerx-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Per Page', 'playerx-core' ),
							'description' => esc_html__( 'Set number of items for your portfolio list. Enter -1 to show all.', 'playerx-core' ),
							'value'       => '-1'
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'image_proportions',
							'heading'     => esc_html__( 'Image Proportions', 'playerx-core' ),
							'value'       => array(
								esc_html__( 'Original', 'playerx-core' )  => 'full',
								esc_html__( 'Square', 'playerx-core' )    => 'square',
								esc_html__( 'Landscape', 'playerx-core' ) => 'landscape',
								esc_html__( 'Portrait', 'playerx-core' )  => 'portrait',
								esc_html__( 'Medium', 'playerx-core' )    => 'medium',
								esc_html__( 'Large', 'playerx-core' )     => 'large'
							),
							'description' => esc_html__( 'Set image proportions for your portfolio list.', 'playerx-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'gallery' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_fixed_proportions',
							'heading'     => esc_html__( 'Enable Fixed Image Proportions', 'playerx-core' ),
							'value'       => array_flip( playerx_edge_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Set predefined image proportions for your masonry portfolio list. This option will apply image proportions you set in Portfolio Single page - dimensions for masonry option.', 'playerx-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'masonry' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_image_shadow',
							'heading'     => esc_html__( 'Enable Image Shadow', 'playerx-core' ),
							'value'       => array_flip( playerx_edge_get_yes_no_select_array( false ) ),
							'save_always' => true
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'category',
							'heading'     => esc_html__( 'One-Category Portfolio List', 'playerx-core' ),
						...
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'tag',
							'heading'     => esc_html__( 'One-Tag Portfolio List', 'playerx-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Item Style', 'playerx-core' ),
							'value'      => array(
								esc_html__( 'Standard - Shader', 'playerx-core' )                 => 'standard-shader',
								esc_html__( 'Standard - Switch Featured Images', 'playerx-core' ) => 'standard-switch-images',
								esc_html__( 'Gallery - Overlay', 'playerx-core' )                 => 'gallery-overlay',
								esc_html__( 'Gallery - Slide From Image Bottom', 'playerx-core' ) => 'gallery-slide-from-image-bottom'
							),
							'group'      => esc_html__( 'Content Layout', 'playerx-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'content_top_margin',
							'heading'    => esc_html__( 'Content Top Margin (px or %)', 'playerx-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Bottom Margin (px or %)', 'playerx-core' ),
							'dependency' => array( 'element' => 'item_style', 'value' => array( 'standard-shader', 'standard-switch-images' ) ),
							'group'      => esc_html__( 'Content Layout', 'playerx-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Title', 'playerx-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Title Text Transform', 'playerx-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Enable Category', 'playerx-core' ),
							'value'      => array_flip( playerx_edge_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Content Layout', 'playerx-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Number of Images', 'playerx-core' ),
							'value'      => array_flip( playerx_edge_get_yes_no_select_array( false, true ) ),
							'dependency' => array( 'element' => 'type', 'value' => array( 'gallery' ) ),
							'group'      => esc_html__( 'Content Layout', 'playerx-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Excerpt', 'playerx-core' ),
							'value'      => array_flip( playerx_edge_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Content Layout', 'playerx-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Excerpt Length', 'playerx-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Type', 'playerx-core' ),
							'value'      => array(
								esc_html__( 'None', 'playerx-core' )            => 'no-pagination',
								esc_html__( 'Standard', 'playerx-core' )        => 'standard',
								esc_html__( 'Load More', 'playerx-core' )       => 'load-more',
								esc_html__( 'Infinite Scroll', 'playerx-core' ) => 'infinite-scroll'
							),
							'group'      => esc_html__( 'Additional Features', 'playerx-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'load_more_top_margin',
							'heading'    => esc_html__( 'Load More Top Margin (px or %)', 'playerx-core' ),
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'filter',
							'heading'    => esc_html__( 'Enable Category Filter', 'playerx-core' ),
							'value'      => array_flip( playerx_edge_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Additional Features', 'playerx-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Order By', 'playerx-core' ),
							'value'      => array(
								esc_html__( 'Name', 'playerx-core' )  => 'name',
								esc_html__( 'Count', 'playerx-core' ) => 'count',
								esc_html__( 'Id', 'playerx-core' )    => 'id',
								esc_html__( 'Slug', 'playerx-core' )  => 'slug'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Filter Text Transform', 'playerx-core' ),
							'value'      => array_flip( playerx_edge_get_text_transform_array( true ) ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'playerx-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Bottom Margin (px or %)', 'playerx-core' ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'playerx-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Enable Article Animation', 'playerx-core' ),
							'value'       => array_flip( playerx_edge_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Enabling this option you will enable appears animation for your portfolio list items', 'playerx-core' ),
							'group'       => esc_html__( 'Additional Features', 'playerx-core' )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$additional_params['holder_data']          = playerx_edge_get_holder_data_for_cpt( $params, $additional_params );
		...
		$html = playerx_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder', $params['type'], $params, $additional_params );
	...
	public function getHolderInnerClasses( $params ) {
        ...
        if($params['portfolio_slider_on'] === 'yes') {
            if($params['enable_fullheight'] === 'yes') {
                $classes[] = 'edgtf-ps-full-height';
            }
            if($params['portfolio_slider_full_height_decrease'] === 'yes') {
                $classes[] = 'edgtf-ps-full-height-decreased';
            }
        }
	...
	public function getArticleClasses( $params ) {
		...
		$classes[] = ! empty( $masonry_size ) && $type === 'masonry' ? 'edgtf-masonry-size-' . esc_attr( $masonry_size ) : 'edgtf-masonry-size-small';
		...
		if ( $params['type'] == 'masonry' && $params['enable_fixed_proportions'] === 'yes' ) {
			...
			switch ( $fixed_image_size ) {
				...
				case 'large-width-height':
					$thumb_size = 'playerx_edge_image_huge';
					break;
				default :
					$thumb_size = 'full';
					break;
	...
	public function getStandardContentStyles( $params ) {
		...
		if ( ! empty( $margin_top ) ) {
			if ( playerx_edge_string_ends_with( $margin_top, '%' ) || playerx_edge_string_ends_with( $margin_top, 'px' ) ) {
		...
		if ( ! empty( $margin_bottom ) ) {
			if ( playerx_edge_string_ends_with( $margin_bottom, '%' ) || playerx_edge_string_ends_with( $margin_bottom, 'px' ) ) {
	...
	public function getLoadMoreStyles( $params ) {
		...
		if ( ! empty( $params['load_more_top_margin'] ) ) {
			...
			if ( playerx_edge_string_ends_with( $margin, '%' ) || playerx_edge_string_ends_with( $margin, 'px' ) ) {
				$styles[] = 'margin-top: ' . $margin;
			} else {
				$styles[] = 'margin-top: ' . playerx_edge_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getFilterHolderStyles( $params ) {
		...
		if ( ! empty( $params['filter_bottom_margin'] ) ) {
			...
			if ( playerx_edge_string_ends_with( $margin, '%' ) || playerx_edge_string_ends_with( $margin, 'px' ) ) {
				...
				$styles[] = 'margin-bottom: ' . playerx_edge_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getItemLink() {
		...
		return apply_filters( 'playerx_edge_filter_portfolio_external_link', $portfolio_link );
	}
	...
	public function getItemLinkTarget() {
		...
		return apply_filters( 'playerx_edge_filter_portfolio_external_link_target', $portfolio_link_target );
	}
	...
	public function portfolioCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['portfolio_category_title'] ) > 0 ) ? esc_html__( 'Category', 'playerx-core' ) . ': ' . $value['portfolio_category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_category ) ) {
				...
				if ( ! empty( $portfolio_category_title ) ) {
					$portfolio_category_title_display = esc_html__( 'Category', 'playerx-core' ) . ': ' . $portfolio_category_title;
				}
	...
	public function portfolioIdAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data          = array();
				$data['value'] = $value['id'];
				$data['label'] = esc_html__( 'Id', 'playerx-core' ) . ': ' . $value['id'] . ( ( strlen( $value['title'] ) > 0 ) ? ' - ' . esc_html__( 'Title', 'playerx-core' ) . ': ' . $value['title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( ! is_wp_error( $portfolio ) ) {
				...
				if ( ! empty( $portfolio_title ) ) {
					$portfolio_title_display = ' - ' . esc_html__( 'Title', 'playerx-core' ) . ': ' . $portfolio_title;
				}
				
				$portfolio_id_display = esc_html__( 'Id', 'playerx-core' ) . ': ' . $portfolio_id;
	...
	public function portfolioTagAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data          = array();
				$data['value'] = $value['slug'];
				$data['label'] = ( ( strlen( $value['portfolio_tag_title'] ) > 0 ) ? esc_html__( 'Tag', 'playerx-core' ) . ': ' . $value['portfolio_tag_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_tag ) ) {
				...
				if ( ! empty( $portfolio_tag_title ) ) {
					$portfolio_tag_title_display = esc_html__( 'Tag', 'playerx-core' ) . ': ' . $portfolio_tag_title;
				}
