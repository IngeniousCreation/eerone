<?php
namespace PlayerxInstagram\Lib;
...
class ShortcodeLoader {
    ...
    private function addShortcodes() {
	    $shortcodes_class_name = apply_filters('playerx_instagram_filter_add_vc_shortcode', $shortcodes_class_name = array());
    ...
    public function load() {
    	if(playerx_instagram_theme_installed()) {
		    $this->addShortcodes();
